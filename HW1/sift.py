...
def sift_matches(
    ...
    # The shape of X1 is expected to be (3, numMatches). The first two rows represent the x, y coordinates of the feature points in the first image, and the third row is filled with ones, which corresponds to homogeneous coordinates. The number of columns numMatches corresponds to the number of feature point matches found between the two images.
